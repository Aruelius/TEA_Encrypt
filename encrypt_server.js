...
Encryption = function() {
    ...
    function h(e, i, n, o) {
        ...
        Buffer.from(g(h)).toString('base64').replace(/[\/\+=]/g, function(t) {
            return {
                "/": "-",
                "+": "*",
                "=": "_"
...
function getPassword(qq,pwd,verifycode) {
    var salt = getSalt(qq)
    var safe = undefined
    var enpwd = Encryption.getEncryption(pwd, salt,verifycode , safe)
    return enpwd
}
...
server.get('/', function (request, response) {
    ...
    var vcode = request['query']['vcode']
    var password = getPassword(qq,pwd,vcode)
